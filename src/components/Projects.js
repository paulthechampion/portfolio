...
import nvPic from '../images/icon.png'
...
export default function Projects() {
    const projectsData = [ 
        {name: "NV", img: nvPic, skills:["React Native", "React JS", "MongoDB", "Node JS", "JavaScript", "Expo", "Express", "CSS", "and more"], link: "https://www.nv.luxury",github : "", words:"NV is a mobile application that enables users to buy and sell Art and Jewellery from their favorite Creator. It is being created using React Native, React JS for the web version, Node JS, Express and MongoDB for the backend. This app is still under development and will be launched soon"}, 
       ...
       {name: "Read Rubixx", isApp: true, img: rubixPic, skills:["EJS","CSS", "JavaScript", "Node Js", "Express","PDF Js", "MongoDB"], link: "https://rubixx-cb010e7e5dc8.herokuapp.com",github : "https://github.com/paulthechampion/rubix", words:"Rubixx is a Full-stack online book library, it saves authors and their books. Also enables users to read books. This as created using the MERN stack as well as PDF.js library to read the books"},  
        ...
        {name: "Todo App", isApp: true, img: todoPic, skills:["CSS", "JavaScript", "Node Js", "Express","React Js", "MongoDB",], link: "https://champs-todo-5f09601771da.herokuapp.com/",github : "https://github.com/paulthechampion/todoApp", words:"A Full-stack Todo app, saves Todo tasks and arranges them in a tabular format"}
    ]
