...
export default function Projects() {
    const projectsData = [ 
       ...
       {name: "Emaily",  isApp: true, img: surveyPic, skills:["CSS", "JavaScript", "Node Js", "Express","React Js","Redux", "MongoDB",], link: "https://emailyy-ccee99329400.herokuapp.com",github : "https://github.com/paulthechampion/email-list", words:"Emaily is a survey dispatch service, it enables the users to send surveys to a series of emails and receive feedback. This app is still in the test phase, it was created using Mongodb, Express Js, React Js, Redux, Redux Forms, Stripe for payment integration, SendGrid,Node js and many more"}, 
        {name: "Todo App", isApp: true, img: todoPic, skills:["CSS", "JavaScript", "Node Js", "Express","React Js", "MongoDB",], link: "https://xtodox-4eec1b19854a.herokuapp.com/signin",github : "https://github.com/paulthechampion/todoApp", words:"A Full-stack Todo app, saves Todo tasks and arranges them in a tabular format"}
    ]
