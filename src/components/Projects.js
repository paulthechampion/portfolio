...
export default function Projects() {
    const projectsData = [ 
        {name: "NV", img: nvPic, skills:["React Native", "React JS", "MongoDB", "Node JS", "JavaScript", "Expo", "Express", "CSS", "and more"], link: "https://www.nv.luxury",github : "", words:"NV is a mobile application that enables Creators to Auction or Sell Art and Jewellery. This app is still under development and will be launched soon"}, 
